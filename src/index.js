...
const options = require("yargs")
	.options(yargOptions)
	.example(
		"$0 --mode live --input-dir ./files --output-dir ./cloud",
		"Extracts the cloud annotated functions of the current directory, deploys them to AWS and prepares the local files"
	)
	.wrap(null)
	.help().argv;
